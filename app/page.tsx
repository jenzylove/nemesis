...
type IncidentDiscovery={source:"bitquery";selected_transaction_hash:string;selected_score:number;candidate_count:number;incident_time:string|null;candidates:DiscoveryCandidate[]};
